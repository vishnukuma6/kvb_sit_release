    ...
    function load() {
        ...
        schedule_check.then(function(result) {
            if (result.data > 0) {
                ...
                //if(window.confirm("Do you want to close previous session?")){
                //sessionStorage.setItem('today',  $scope.maindata);
                //$window.location.href = "../welcome";
                //}
                alert(result.data);
...
function load_otp() {
        ...
        schedule_check.then(function(result) {
            ...
            alert('Incorrect OTP. Kindly regenerate OTP and try again');
        });
    };
        ...
        pswd.then(function(result) {
                ...
                return false;
                  ...
                  $scope.maindata = result.data;
                    ...
                    $scope.auth_request = $scope.maintable.auth_request;
