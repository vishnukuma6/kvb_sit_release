...
def check_memo_employee_num(data):
    ...
    headers = {"content-type": "application/json", "Authorization": "Token "+"" + generated_token_data + ""}
    ...
    if request.method == 'POST':
        ...
        if condition_ == '0':
            ...
            if validatewithmemo == 'SUCCESS':
                ...
                if validatewithmemo==' The Mobile Number Already Exist for Another User  Try with new Mobile number':
                    return HttpResponse('{"MESSAGE":"This mobile no is already registered to another user id"}')
                else:
