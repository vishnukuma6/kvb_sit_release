...
def eclaim_withfile_set(request):
    ...
    if request.method == 'POST':
        ...
        data_advance = request.POST['ADVANCE']
        data_ccbs = json.loads(data_ccbs)
        data_advance = json.loads(data_advance)
...
def eclaim_summary(request):
    ...
    if request.method == 'POST':
        ...
        if typ =='CLAIM_REQUEST':
        ...
        elif typ =='EXPENSE_REPORT_SUMMARY':
            params = {"Type": typ,
                      "Api_Type": "WEB"}
            token = jwt.token(request)
            headers = {"content-type": "application/json", "Authorization": "" + token + ""}
            ...
            dictionary = jsondata.get('params').get('json').get('Params').get("FILTER")
            for key,value in dictionary.items():
                params[key] = value
            resp = requests.get("" + ip + "/TOURNO_EXPENSE_REPORT", params=params, data=datas, headers=headers,
                                 verify=False)
            response = resp.content.decode("utf-8")
            return HttpResponse(response)

        elif typ =='ALLOWANCE_SUMMARY':
            params = {}
            token = jwt.token(request)
            headers = {"content-type": "application/json", "Authorization": "" + token + ""}
            datas = {}
            ...
            for key,value in dictionary.items():
                params[key] = value
            resp = requests.get("" + ip + "/ALLOWANCE", params=params, data=datas, headers=headers,
                                 verify=False)
            response = resp.content.decode("utf-8")
            return HttpResponse(response)

        elif typ =='TOURDATE_RELAXATION_SUMMARY':
            params = {}
            token = jwt.token(request)
            headers = {"content-type": "application/json", "Authorization": "" + token + ""}
            datas = {}
            ...
            for key,value in dictionary.items():
                params[key] = value
            resp = requests.get("" + ip + "/TOURDATE_RELAXATION", params=params, data=datas, headers=headers,
                                 verify=False)
            response = resp.content.decode("utf-8")
            return HttpResponse(response)
...
def eclaim_dropdata(request):
    ...
    if request.method == 'GET':
        ...
        if typ =='TOUR_REASON':
            ...
            params = {"Type":request.GET['SubType']}
            token = jwt.token(request)
            headers = {"content-type": "application/json", "Authorization": "" + token + ""}
            data['Params']["FILTER"]["Entity_Gid"] = decry_data(request.session['Entity_gid'])
            data['Params']["FILTER"]["Employee_gid"] = decry_data(request.session['Emp_gid'])
            ...
            for key, value in dictionary.items():
                params[key] = value
            resp = requests.get("" + ip + "/DEPENDENT_DETAILS", params=params, data=data, headers=headers,
                                 verify=False)
            response = resp.content.decode("utf-8")
            return HttpResponse(response)
        ...
        elif typ =='ALL_EMPLOYEE_DATA':
            employee_gid = onbehalf_check(request)
            filter = data.get('filter')
            entity = request.session['Entity_gid']
            Where_Primary =""
            Primary_Value =""
            if 'branch_gid' in data:
                Where_Primary ="branch_gid"
                Primary_Value = data.get('branch_gid')
            Search_Column = ""
            Search_Column_Name = ""
            if filter.strip().isdigit():
                Search_Column = filter
            else:
                Search_Column_Name = filter
            drop_b = {
                "Table_name": "gal_mst_temployee",
                "Column_1": "employee_gid,employee_code,employee_name",
                "Column_2": "",
                "Where_Common": "employee",
                "Where_Primary": Where_Primary,
            ...
            for i in range(len(data.get('DATA'))):
                if int(data.get('DATA')[i].get('employee_gid')) == int(employee_gid):
                    del data.get('DATA')[i]
                    break
            data1 = data
...
def eclaim_process_set(request):
    ...
    if request.method == 'POST':
        ...
        if type =='MOVE_REJECT':
        ...
        elif type =='ADVANCE_APPROVEAMOUNT_SET':
            params = {"Type": type,
                      "Api_Type": "WEB"}
            token = jwt.token(request)
            headers = {"content-type": "application/json", "Authorization": "" + token + ""}
            ...
            jsondata['params']['json']['Params']['DETAILS']["Entity_Gid"] = decry_data(request.session['Entity_gid'])
            datas = json.dumps(jsondata.get('params').get('json'))
            resp = requests.post("" + ip + "/ADVANCE_APPROVEAMOUNT_SET", params=params, data=datas, headers=headers,
                                 verify=False)
            response = resp.content.decode("utf-8")
            return HttpResponse(response)

        elif type =='TOURDATE_RELAXATION':
            params = {"Type": type,
                      "Api_Type": "WEB"}
            token = jwt.token(request)
            headers = {"content-type": "application/json", "Authorization": "" + token + ""}
            datas = json.dumps(jsondata.get('params').get('json').get('Params').get('DETAILS'))
            resp = requests.post("" + ip + "/TOURDATE_RELAXATION", params=params, data=datas, headers=headers,
                                 verify=False)
            response = resp.content.decode("utf-8")
            return HttpResponse(response)

        elif type =='FILE_DELETE':
            params = {"Type": type,
                      "Api_Type": "WEB"}
            token = jwt.token(request)
            headers = {"content-type": "application/json", "Authorization": "" + token + ""}
            ...
            jsondata['params']['json']['Params']['FILTER']["Entity_Gid"] = decry_data(request.session['Entity_gid'])
            datas = json.dumps(jsondata.get('params').get('json'))
            resp = requests.post("" + ip + "/FILE_DELETE", params=params, data=datas, headers=headers,
                                 verify=False)
            response = resp.content.decode("utf-8")
            return HttpResponse(response)
...
def expense_detail(request):
    ...
    if request.method == 'GET':
        ...
        if typ =='DLYDM':
            ...
            for key,value in dictionary.items():
                params[key] = value
            resp = requests.get("" + ip + "/LOCAL_DEP_EXP_DETAIL_GET", params=params, data={}, headers=headers,
                                 verify=False)
            response = resp.content.decode("utf-8")
            return HttpResponse(response)
        ...
        if typ == 'ELIGIBLE_AMOUNT_DAILYDIEM':
        ...
        elif typ == 'ELIGIBLE_AMOUNT_LOCAL_DEP':
            params = {"Type": request.session['type'],
                      "Api_Type": "WEB"}
            employee_gid = onbehalf_check(request)
            token = jwt.token(request)
            ...
            jsondata['params']['json']['Params']["FILTER"]["Employee_gid"] = employee_gid
            datas = json.dumps(jsondata.get('params').get('json').get('Params').get('FILTER'))
            resp = requests.post("" + ip + "/LOCAL_DEP_EXP_ELIGIBLITY_CALC", params=params, data=datas, headers=headers,
                                 verify=False)
            response = resp.content.decode("utf-8")
            return HttpResponse(response)
            ...
            jsondata = onbehalf_data(request, jsondata)
            datas = json.dumps(jsondata.get('params').get('json'))
            resp = requests.post("" + ip + "/LOCAL_DEP_EXP_DETAIL_SET", params=params, data=datas, headers=headers,
                                 verify=False)
            response = resp.content.decode("utf-8")
            return HttpResponse(response)
    ...
    if request.method == 'POST':
        ...
        if request.FILES:
            for i in range(0, len(request.FILES)):
                name = "file" + str(i)
                file_data = request.FILES[name].read()
                # file = {'file': request.FILES[name]}
                file = {'file': file_data}
        params = {}
        token = jwt.token(request)
        datas = {}
        headers = {"Authorization": "" + token + ""}
        resp = requests.post("" + ip + "/ALLOWANCE",files = file,headers=headers,
                             verify=False)
        response = resp.content.decode("utf-8")
        return HttpResponse(response)
