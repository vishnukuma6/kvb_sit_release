...
urlpatterns = [
    ...
    path('PPR_Reviewer_Get',view_report.PPR_BudgetReviewer_Get.as_view()),
    path('PPR_Reviewer_Set',view_report.PPR_BudgetReviewer_Set.as_view()),
    path('pprMonoMicro',view_report.PPR_Mono_Micro_GET.as_view()),
