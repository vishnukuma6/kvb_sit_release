    ...
    def post(self,request):
        try:
            if self.request.query_params.get("Group") == "SUMMARY":
                ...
                obj_dealerprice.create_by = self.request.query_params.get("Employee_Gid")
    ...
    def post(self,request):
        try:
            if self.request.query_params.get("Group") == "SUMMARY":
                ...
                obj_salesrate.json_classification = json.dumps(jsondata.get('Params').get('CLASSIFICATION'))
                obj_salesrate.create_by = self.request.query_params.get("Employee_Gid")
    ...
    def post(self,request):
        try:
            if self.request.query_params.get("Group")== "SALES_INV_PROCESS":
                ...
                obj_soinvprocess.create_by=self.request.query_params.get("Create_by")
    ...
    def post(self, request):
        try:
            if self.request.query_params.get("Group") == "INV_DISPATCH_PROCESS":
                ...
                obj_invdipatch.create_by = self.request.query_params.get("Employee_Gid")
